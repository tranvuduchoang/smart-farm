...
import { FaLeaf, FaHandshake, FaShieldAlt, FaUsers, FaGlobe, FaTruck, FaLinkedin, FaTwitter, FaEnvelope } from "react-icons/fa";
      ...
      <section className="about-hero">
        <div className="hero-content">
          ...
          <p className={`hero-subtitle ${isVisible ? 'animate-fade-in' : ''}`}>
            Kết nối nông dân Việt Nam với thế giới thông qua công nghệ và niềm tin
          </p>
        </div>
        ...
        <div className="container">
          <div className="mission-content">
            <div className="mission-text">
              ...
              <p>
                AgriChain được thành lập với sứ mệnh kết nối trực tiếp nông dân Việt Nam 
                với người tiêu dùng, đảm bảo sản phẩm tươi ngon, an toàn và có nguồn gốc 
                rõ ràng đến tay khách hàng.
              </p>
              <p>
                Chúng tôi tin rằng công nghệ có thể giúp nông nghiệp Việt Nam phát triển 
                bền vững, tạo ra giá trị cho cả nông dân và người tiêu dùng, đồng thời 
        ...
        <div className="container">
          ...
          <div className="values-grid">
            <div className="value-card">
              ...
              <h3>Bền vững</h3>
              <p>
                Chúng tôi cam kết phát triển nông nghiệp bền vững, 
            ...
            <div className="value-card">
              ...
              <h3>Minh bạch</h3>
              <p>
                Mọi sản phẩm đều có thể truy xuất nguồn gốc rõ ràng 
            ...
            <div className="value-card">
              ...
              <h3>Chất lượng</h3>
              <p>
                Đảm bảo chất lượng cao nhất cho mọi sản phẩm 
                thông qua quy trình kiểm soát nghiêm ngặt.
              </p>
            </div>
            <div className="value-card">
              <div className="value-icon">
              ...
              <h3>Cộng đồng</h3>
              <p>
                Xây dựng cộng đồng nông dân và người tiêu dùng 
                có ý thức về sản phẩm sạch.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="timeline">
            {achievements.map((achievement, index) => (
              <div key={achievement.year} className={`timeline-item ${index % 2 === 0 ? 'left' : 'right'}`}>
        ...
        <div className="container">
          ...
          <div className="impact-grid">
            <div className="impact-card">
              ...
              <h3>Môi trường</h3>
              <p>Giảm 30% khí thải carbon thông qua tối ưu hóa chuỗi cung ứng</p>
      ...
      <section className="contact-cta">
        <div className="container">
          <div className="cta-content">
            ...
            <p>
              Hãy cùng AgriChain xây dựng tương lai bền vững cho nông nghiệp Việt Nam
            </p>
