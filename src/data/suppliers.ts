...
export const suppliers: Supplier[] = [
  {
    ...
    description:
      "Trang trại gia đình với hơn 20 năm kinh nghiệm trồng rau củ hữu cơ tại Đà Lạt. Chúng tôi cam kết cung cấp những sản phẩm tươi ngon nhất với chất lượng đảm bảo.",
  ...
  },
  {
    ...
    description:
      "Hợp tác xã chuyên canh xoài cát Hòa Lộc với quy mô 200 thành viên. Sản phẩm được xuất khẩu sang nhiều nước trên thế giới.",
    location: "Tiền Giang",
  ...
  },
  {
    ...
    description:
      "Trang trại chăn nuôi bò Wagyu đầu tiên tại Việt Nam, áp dụng công nghệ và quy trình chăn nuôi hiện đại theo tiêu chuẩn Nhật Bản.",
    location: "Bình Dương",
  ...
  },
  {
    ...
    description:
      "Công ty nuôi trồng và chế biến thủy sản hàng đầu Việt Nam, chuyên nuôi tôm sú và tôm thẻ chân tr���ng theo tiêu chuẩn quốc tế.",
    location: "Cà Mau",
  ...
  },
  {
    ...
    description:
      "Trang trại rau sạch quy mô lớn tại vùng ĐBSCL, chuyên cung cấp rau củ quả tươi sạch cho thị trường trong nước và xuất khẩu.",
    location: "An Giang",
  ...
  },
  {
    ...
    description:
      "Đơn vị chuyên sản xuất các sản phẩm sữa organic chất lượng cao từ đàn bò được nuôi trong môi trường tự nhiên hoàn toàn.",
    location: "Nghệ An",
