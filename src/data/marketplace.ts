...
export const marketplaceProducts: Product[] = [
  {
    ...
    description:
      "Cà chua tươi ngon, hữu cơ 100% từ nông trại Đà Lạt. Không sử dụng thuốc tr��� sâu, giàu vitamin C và lycopene.",
  ...
  },
  {
    ...
    description:
      "Xoài cát Hòa Lộc chính gốc Tiền Giang, thịt dày, ngọt thanh, thơm đậm đà. Trái to đều, không tẩm hóa chất.",
  ...
  },
  {
    ...
    description:
      "Thịt bò Wagyu A5 chất lượng cao, thịt mềm, mùi vị đậm đà. Nuôi theo tiêu chuẩn Nhật Bản.",
  ...
  },
  {
    ...
    description:
      "Sữa tươi organic từ bò nuôi thả tự nhiên, không hormone tăng trưởng, giàu protein và canxi.",
  ...
  },
  {
    ...
    description:
      "Bánh mì nguyên cám tự nhiên, không chất bảo quản, giàu chất xơ, tốt cho sức khỏe.",
  ...
  },
  {
    ...
    description:
      "Tôm sú tươi sống từ trang trại nuôi ở Cà Mau, size 20-25 con/kg, thịt chắc ngọt.",
  ...
  },
  {
    ...
    description:
      "Rượu vang đỏ từ nho trồng tại Đà Lạt, hương vị thơm ngon, độ cồn 12.5%.",
  ...
  },
  {
    ...
    description:
      "Rau cải ngọt tươi, trồng theo phương pháp hữu cơ, không thuốc trừ sâu.",
